...
static CGFloat const kHooDatePickerHeight = 216.0f;

//static CGFloat const kHooDatePickerHeaderHeight = 44.0f;
static CGFloat const kHooDatePickerHeaderHeight = 0.0f;
...
static CGFloat const kHooDatePickerLineWidth = 0.5f;
...
// Constants times :
static CGFloat const kHooDatePickerAnimationDuration = 0.3f;
...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, superView.frame.size.height, superView.frame.size.width, kHooDatePickerHeight)]) {
        ...
        self.cancelButtonColor = [UIColor colorWithHex:0x3399FF];
        self.sureButtonColor = [UIColor colorWithHex:0x3399FF];
//        //改变了确定和取消按钮的颜色
//        self.cancelButtonColor = kHooDatePickerHighlightColor;
//        self.sureButtonColor = kHooDatePickerHighlightColor;
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate {
    ...
    //修改
    self.selectedHooDate = selectedDate;
...
- (void)setScrollView:(UIScrollView*)scrollView atIndex:(NSInteger)index animated:(BOOL)animated {
    ...
    //修改
    self.selectedHooDate = [self getDate];
}
